...
Coleccion con **aserciones** para las historias HU-HER-001 a HU-HER-010, HU-JUE-009 y HU-SIM-001: cada
...
| Archivo | Que es |
|---|---|
| `heroes.postman_collection.json` | La coleccion: 34 peticiones, 113 aserciones, agrupadas por historia |
