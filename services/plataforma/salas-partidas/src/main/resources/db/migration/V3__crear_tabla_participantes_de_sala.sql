...
-- Es V3 y no V2 porque V2 la ocupo el chat de HU-JUE-015 (#272), que entro
-- antes en la rama base; Flyway no admite dos migraciones con la misma version
-- y una migracion ya aplicada no se renombra.
--
