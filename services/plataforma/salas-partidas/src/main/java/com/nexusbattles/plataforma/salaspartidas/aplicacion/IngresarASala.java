 ...
 *
 * <p>Coordina tres pasos y nada mas: buscar la sala, pedirle que admita al
 * jugador, y guardar el resultado. Las reglas de quien puede entrar viven en
 * {@link Sala#unirse(UUID)}, no aqui: si una condicion de ingreso apareciera en
 * esta clase, estaria en el sitio equivocado.
 *
...
public class IngresarASala {
    ...
    public IngresarASala(RepositorioDeSalas repositorio) {
    ...
    public Sala ejecutar(UUID idSala, UUID idJugador) {
        ...
        // admitio a nadie no tiene por que reescribirse.
