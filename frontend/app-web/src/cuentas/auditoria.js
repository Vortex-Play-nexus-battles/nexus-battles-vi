...
(() => {
  ...
  /**
   * Exporta el registro filtrado a CSV (HU-AUD-004) y dispara la descarga
  ...
  async function exportar() {
    const textoOriginalBoton = el.btnExportar.textContent;
    el.btnExportar.disabled = true;
    el.btnExportar.textContent = 'Exportando…';
    ...
    try {
      ...
      el.btnExportar.textContent = textoOriginalBoton;
    }
  }
